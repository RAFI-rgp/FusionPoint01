    ...
    <div className="fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        >
          ...
          {mode === "media" && previewUrl && (
            media?.type.startsWith("image") ? (
              ...
              <video src={previewUrl} className="object-contain max-h-full" controls autoPlay />
            )
          )}
        </div>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-liner-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition cursor-pointer"
        >
