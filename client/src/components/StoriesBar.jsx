      ...
      <div className="flex gap-4 pb-5">
        ...
        <div
          ...
          className="
            ...
            bg-lenier-to-b from-indigo-50 to-white
          "
        >
        ...
        {stories.map((story, index) => (
          <div
            ...
            className="
              ...
              cursor-pointer 
              hover:shadow-lg transition-all duration-200 
              bg-lenier-to-b from-indigo-500 to-purple-600 
          ...
          >
            ...
            <p className="absolute top-16 left-3 text-white/60 text-sm truncate max-w-[90px]">
              {story.content}
            </p>
